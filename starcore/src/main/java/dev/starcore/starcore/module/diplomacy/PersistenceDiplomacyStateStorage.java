...
final class PersistenceDiplomacyStateStorage implements DiplomacyStateStorage {
    private static final String FILE_NAME = "relations.properties";

    private final String namespace;
    private final PersistenceService persistenceService;

    PersistenceDiplomacyStateStorage(String namespace, PersistenceService persistenceService) {
