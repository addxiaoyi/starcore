...
final class PersistenceTechnologyStateStorage implements TechnologyStateStorage {
    private static final String FILE_NAME = "technologies.properties";

    private final String namespace;
    private final PersistenceService persistenceService;

    PersistenceTechnologyStateStorage(String namespace, PersistenceService persistenceService) {
