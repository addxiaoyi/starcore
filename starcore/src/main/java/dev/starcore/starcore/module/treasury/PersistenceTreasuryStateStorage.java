...
final class PersistenceTreasuryStateStorage implements TreasuryStateStorage {
    private static final String FILE_NAME = "treasury.properties";

    private final String namespace;
    private final PersistenceService persistenceService;

    PersistenceTreasuryStateStorage(String namespace, PersistenceService persistenceService) {
