...
final class PersistenceResourceStateStorage implements ResourceStateStorage {
    private static final String FILE_NAME = "resources.properties";

    private final String namespace;
    private final PersistenceService persistenceService;

    PersistenceResourceStateStorage(String namespace, PersistenceService persistenceService) {
