...
final class PersistencePolicyStateStorage implements PolicyStateStorage {
    private static final String FILE_NAME = "policies.properties";

    private final String namespace;
    private final PersistenceService persistenceService;

    PersistencePolicyStateStorage(String namespace, PersistenceService persistenceService) {
