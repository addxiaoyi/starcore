...
final class PersistenceResolutionStateStorage implements ResolutionStateStorage {
    private static final String FILE_NAME = "resolutions.properties";

    private final String namespace;
    private final PersistenceService persistenceService;

    PersistenceResolutionStateStorage(String namespace, PersistenceService persistenceService) {
