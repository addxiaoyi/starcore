...
final class PersistenceNationStateStorage implements NationStateStorage {
    private static final String FILE_NAME = "nations.properties";

    private final String namespace;
    private final PersistenceService persistenceService;

    PersistenceNationStateStorage(String namespace, PersistenceService persistenceService) {
