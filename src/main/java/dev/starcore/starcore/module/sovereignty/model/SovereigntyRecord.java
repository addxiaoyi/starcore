 ...
 */
public record SovereigntyRecord(
        UUID id,
        NationId nationId,
        String regionName,
        String description,
     ...
     * 创建一个新的主权声明
     */
    public static SovereigntyRecord create(
            NationId nationId,
            String regionName,
            String description,
            SovereigntyService.SovereigntySignificance significance
    ...
    public String toString() {
        return String.format("SovereigntyRecord{id=%s, region='%s', nation=%s, status=%s, significance=%s, strength=%d}",
